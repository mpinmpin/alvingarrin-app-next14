...
const About = () => {
    return ( 
        <main>
            <div className="about">
                <h2>About me</h2>
                <p>Hi, I&lsquo;m Alvin Garrin, a 33 y/o web developer from Depok, Indonesia.</p>
                <p>I&lsquo;m a web developer (and programming) enthusiast for over 2 years, working with TypeScript, HTML5, CSS3, React.js, and Next.js. I have built simple apps here like weather app, blog pages and BMI calculator. I might work with larger projects in the near future.</p>

	...
	return ( 
		<main>
			<div className="about">
				...
				<p>I&lsquo;m a web developer (and programming) enthusiast for over 2 years, working with TypeScript, HTML, CSS, and React/Next.js. I have built simple apps here like weather app, blog pages and BMI calculator. I might work with larger projects in the near future.</p>
